...
class ONIX::SupplyDetail < ONIX::Element
  ...
  onix_repeatable_spaced_codes_from_list :supply_to_countries, "SupplyToCountry", :list => 91
  onix_spaced_codes_from_list :supply_to_territories, "SupplyToTerritory", :list => 49
  onix_repeatable_spaced_codes_from_list :supply_to_countries_excluded, "SupplyToCountryExcluded", :list => 91
